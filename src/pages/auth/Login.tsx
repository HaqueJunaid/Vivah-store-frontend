    ...
    return (
        <div className="flex h-screen w-full bg-stone-50 relative">
            ...
            <div className="w-full flex flex-col items-center justify-center bg-stone-50 md:bg-white relative">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md px-8 py-10 bg-white md:bg-transparent rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] md:shadow-none border border-stone-100 md:border-none flex flex-col items-center justify-center">
